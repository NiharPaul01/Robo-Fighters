...
public class PlayerInputControls : NetworkBehaviour
{
    ...
    public override void OnNetworkSpawn()
    {
        if (GetComponent<NetworkObject>().IsOwner)
        {
            ...
            _playerControlsInputAction.PlayerControlsMap.Shoot.canceled += ShootOnCancelled;
    ...
    {
        OnShootAnglePerformed?.Invoke(obj:context.ReadValue<Vector2>());
    }
    private void ShootOnCancelled(InputAction.CallbackContext obj)
    {
    ...
    { 
        ...
        movementVector = new Vector3(v2Movement.x, y:0, z:v2Movement.y);
    }
